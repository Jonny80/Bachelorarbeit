...
% Abkürzungs- und Glossar-Zähler für Erstnennung
\newcounter{termcount}
...
\renewcommand*{\@acf}[2][\AC@linebreakpenalty]{%
  ...
  \else
    ...
    }\stepcounter{termcount}\textsuperscript{\thetermcount}%
  \fi
...
% Kennzeichnung bei Erstverwendung von Glossareinträgen mit hochgestellter Nummer
\defglsentryfmt{%
  \ifglsused{\glslabel}{%
    \glsgenentryfmt
  }{%
    \glsgenentryfmt\stepcounter{termcount}\textsuperscript{\thetermcount}%
  }%
}
...
\lstdefinelanguage{Javascript}{
  keywords={break, case, catch, continue, debugger, default, delete, do, else, false, finally, for, function, if, in, instanceof, new, null, return, switch, this, throw, true, try, typeof, var, void, while, with, let, const, export, import, from, default, extends, class, return},
  keywordstyle=\color{blue}\bfseries,
...
\lstdefinelanguage{Shell}{
  morekeywords={npx, turbo, npm, run, add, dev},
  keywordstyle=\color{blue}\bfseries,
  sensitive=false,
  morecomment=[l]{\#},
  morestring=[b]",
