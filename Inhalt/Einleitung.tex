...
\begin{description}
    ...
    \item[FF2:] Welche Synchronisationsstrategien eignen sich, um eine konsistente Datenhaltung zwischen mobilen Clients und einem Zentralsystem unter volatilen Netzwerkbedingungen auf Großbaustellen zu gewährleisten?
    \item[FF3:] Wie lässt sich eine modulare Multi-Tenant-Architektur für Inbetriebnahmemanagement-Software gestalten, welche funktionale Erweiterungen ermöglicht?
\end{description}
