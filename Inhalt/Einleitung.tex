...
\newline
Zusätzlich verschärft das Problem des Vendor-Locks die Situation \cite{feth2023studie}.
...
\newline
Erschwert wird der digitale Einsatz vor Ort durch die oft mangelhafte Infrastruktur \cite{BBSR}. 
...
Es fehlt jedoch an einer Verknüpfung dieser Modelle mit einer modularen Architektur als Frontend, mit welcher die beschriebenen Probleme aus \ref{1.1}, gezielt angegangen werden können. 
